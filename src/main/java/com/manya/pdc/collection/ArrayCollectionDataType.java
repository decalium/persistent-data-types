...
import com.manya.pdc.collection.CollectionDataType;
...
public class ArrayCollectionDataType<A, Z extends Collection<E>, E, T, K> extends TypeBasedCollectionDataType<A, Z, E, T, K> {
